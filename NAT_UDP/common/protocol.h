...
struct stUserInfo
{
 	char userName[MAX_NAME_SIZE]; /*15个字节的数组*/
	unsigned int userIP;  /*ip地址和端口*/
...
typedef list<stUserInfo*> UserList; /*list类型，元素是指针*/
typedef list<stUserInfo*>::iterator UserList_Iter;  /*迭代器*/
